...
void TestActivationFunctions::setUp() {
    ...
    input_tensor = new pico_cnn::naive::Tensor(1, 10);
    output_tensor = new pico_cnn::naive::Tensor(1, 10);
    expected_output_tensor = new pico_cnn::naive::Tensor(1, 10);
...
void TestActivationFunctions::runTestLRN() {
    ...
    auto lrn_input_tensor = new pico_cnn::naive::Tensor(1, 3, 2, 3);
    auto lrn_output_tensor = new pico_cnn::naive::Tensor(1, 3, 2, 3);
    auto lrn_expected_output_tensor = new pico_cnn::naive::Tensor(1, 3, 2, 3);
...
void TestActivationFunctions::runTestLeakyReLU() {
    ...
    auto lrelu_input_tensor = new pico_cnn::naive::Tensor(1, 11);
    auto lrelu_output_tensor = new pico_cnn::naive::Tensor(1, 11);
    auto lrelu_expected_output_tensor = new pico_cnn::naive::Tensor(1, 11);
...
void TestActivationFunctions::runTestParameterizedReLU() {
    ...
    auto param_relu_input_tensor = new pico_cnn::naive::Tensor(1, 10);
    auto param_relu_output_tensor = new pico_cnn::naive::Tensor(1, 10);
    auto param_relu_expected_output_tensor = new pico_cnn::naive::Tensor(1, 10);
    ...
    auto slope_tensor = new pico_cnn::naive::Tensor(1, 10);
...
void TestActivationFunctions::runTestSigmoid() {
    ...
    auto sigmoid_input_tensor = new pico_cnn::naive::Tensor(1, 10);
    auto sigmoid_output_tensor = new pico_cnn::naive::Tensor(1, 10);
    auto sigmoid_expected_output_tensor = new pico_cnn::naive::Tensor(1, 10);
...
void TestActivationFunctions::runTestSoftmax() {
    ...
    auto softmax_input_tensor = new pico_cnn::naive::Tensor(1, 10);
    auto softmax_output_tensor = new pico_cnn::naive::Tensor(1, 10);
    auto softmax_expected_output_tensor = new pico_cnn::naive::Tensor(1, 10);
...
void TestActivationFunctions::runTestTanH() {
    ...
    auto tanh_input_tensor = new pico_cnn::naive::Tensor(1, 10);
    auto tanh_output_tensor = new pico_cnn::naive::Tensor(1, 10);
    auto tanh_expected_output_tensor = new pico_cnn::naive::Tensor(1, 10);
